...
impl OrderReplaced {
    ...
    /// Gets the previous user reference number as a u32.
    pub fn old_user_ref_num(&self) -> u32 {
        self.old_user_ref_num.val()
    }

    /// Gets the new user reference number as a u32.
    pub fn new_user_ref_num(&self) -> u32 {
        self.new_user_ref_num.val()
    }
